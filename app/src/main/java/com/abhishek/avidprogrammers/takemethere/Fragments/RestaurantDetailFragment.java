package com.abhishek.avidprogrammers.takemethere.Fragments;
...
import com.abhishek.avidprogrammers.takemethere.API.DetailActivityImageAsyncTask;
...
import com.abhishek.avidprogrammers.takemethere.R;
import com.abhishek.avidprogrammers.takemethere.Utils.RestaurantExecutors;
import com.abhishek.avidprogrammers.takemethere.Utils.RestaurantViewModel;
import com.abhishek.avidprogrammers.takemethere.Utils.RestaurantViewModelFactory;
...
public class RestaurantDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(featuredImageURL.isEmpty()) {
            restaurantImage.setImageResource(R.drawable.logo);
        } else {
            try {
